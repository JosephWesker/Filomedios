        ...
        <div class="col-lg-12">    
            <div class="full-width-tabs">
                <ul id="myTabs" class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="active fill_width"><a href="#proyection" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false">Datos para proyección</a></li>
...
<script>
                                                                ...
                                                                var delateFilesRoute = '{{ action('serviceOrderController@postDelateFile'); }}';</script>
