    ...
    <div class="row">                
        <div class="col-lg-12">    
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('amount',null,['class' => 'form-control','id' => 'u_pso_amount','placeholder' => 'Cantidad'])}}
                                    </div>                                                            
                                    <div class=text-right>
            ...
            <div class="col-lg-12">                            
                ...
                <div class="form-group">
                    {{ Form::label('amount','Cantidad')}}
                    {{ Form::number('amount',null,['class' => 'form-control','id' => 'pso_amount','placeholder' => 'Cantidad'])}}
                </div>                                                            
                <div class=text-right>
