            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li {{ (Request::is('*produccion') ? 'class="active"' : '') }}>
                        ...
                        <ul class="nav nav-second-level">
                            <li {{ (Request::is('*agenda') ? '' : '') }}>
                                <a href="{{ url ('agenda') }}"><i class="fa fa-bars"></i>  Agenda</a>
                            </li>
                            <li {{ (Request::is('*gestor_de_archivos') ? '' : '') }}>
                    ...
                    <li {{ (Request::is('*configuracion') ? 'class="active"' : '') }}>
                        ...
                        <ul class="nav nav-second-level">
                            <li {{ (Request::is('*catalogo') ? '' : '') }}>
                                <a href="{{ url ('catalogo') }}"><i class="fa fa-bars"></i> Catálogo</a>
                            </li>
                        </ul>
                    </li>
                </ul>
