...
$(document).ready(function () {
    ...
    $(add_button_payment).click(function (e) {
        ...
        if (q < max_fields_payment) {
            q++;
            w++;
            $(wrapper_payment).append('<div id="' + w + '" class="form-group form-group-sm" style="margin-bottom: 10px!important; display: inline-block; "><label class="col-sm-1 control-label" for="formGroupInputSmall">Monto</label><div class="col-sm-4"><div class=""><div><input class="form-control" id="' + 'payment-' + w + '" style="margin-bottom: 10px!important; display: inline-block;" type="text" name="mytext[]" onkeyup="setFixedPayment(this)"></div></div></div><label class="col-sm-1 control-label" for="formGroupInputSmall">Fecha</label><div class="col-sm-4"><div class=""><div><input class="form-control" id="' + 'payment-' + ++w + '" style="margin-bottom: 10px!important; display: inline-block;" type="date" name="mytext[]" onchange="checkDates()"></div></div></div><a style="color: #c9302c;" href="#" class="remove_field_payment"><i class="fa fa-times-circle" style="float: left; cursor: pointer; font-size: 30px;"></i></a></div>');
        }
        payments++;
        setAmounts();
    });
