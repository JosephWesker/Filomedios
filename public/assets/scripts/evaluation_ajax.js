...
function updateEvaluations() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            resetTable();
            $('#eva_tim_id').html('');
            $('#eva_tim_id').append($("<option></option>").attr("value", 'null').text('---Seleccionar Mes/Año---'));
...
function setEmployees() {
    $('#eva_emp_id').html('');
    $('#eva_emp_id').append($("<option></option>").attr("value", 'null').text('---Seleccionar Empleado---'));
    ...
    $.ajax({
        ...
        success: function(data) {
            $.each(data.data, function(index, value) {
                $('#eva_emp_id').append($("<option></option>").attr("value", value.id).text(value.name));
            });
        }
    });
}
...
function getDates() {
    ...
    if ($('#eva_emp_id').val() != 'null') {
        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data.data, function(index, value) {
                    $('#eva_tim_id').append($("<option></option>").attr("value", value.id).text(value.value));
                });
