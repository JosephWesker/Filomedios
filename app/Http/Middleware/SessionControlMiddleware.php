...
{    
    ...
    public function handle($request, Closure $next) {
        ...
        $permissions['desarrollador'] = array('/', 'gestor_de_ordenes_de_servicio', 'nueva_orden_de_servicio', 'empleados', 'tesoreria', 'facturas', 'clientes', 'lista', 'videos', 'produccion', 'agenda', 'gestor_de_archivos', 'configuracion', 'unidades_negocio', 'programas', 'productos', 'paquetes', 'usuarios');
