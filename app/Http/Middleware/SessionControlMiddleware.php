...
{    
    ...
    public function handle($request, Closure $next) {
    	$permissions = array('vendedor' => array('/', 'perfil', 'gestor_de_ordenes_de_servicio', 'nueva_orden_de_servicio', 'clientes'), 'administrador' => array('/', 'perfil', 'gestor_de_ordenes_de_servicio', 'nueva_orden_de_servicio', 'empleados', 'tesoreria', 'facturas', 'clientes', 'lista', 'videos', 'produccion', 'agenda', 'gestor_de_archivos', 'configuracion', 'unidades_negocio', 'programas', 'productos', 'paquetes', 'usuarios','giros'), 'producción' => array('/', 'perfil', 'gestor_de_ordenes_de_servicio', 'lista', 'videos', 'produccion', 'agenda', 'gestor_de_archivos'), 'tesoreria' => array('/', 'perfil', 'gestor_de_ordenes_de_servicio', 'nueva_orden_de_servicio', 'tesoreria', 'facturas', 'clientes'), 'gerente de ventas' => array('/', 'perfil', 'gestor_de_ordenes_de_servicio', 'nueva_orden_de_servicio', 'clientes'));
